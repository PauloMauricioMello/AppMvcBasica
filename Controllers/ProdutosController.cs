...
namespace AppMvcBasica.Controllers
{
  ...
  public class ProdutosController : Controller
  {
    ...
    {
      ViewData["FornecedorId"] = new SelectList(_context.Fornecedores, dataValueField: "ID", dataTextField: "Nome");
      return View();
    }
    ...
    public async Task<IActionResult> Create(Produto produto)
    {
      ...
      ViewData["FornecedorId"] = new SelectList(_context.Fornecedores, dataValueField: "ID", dataTextField: "Nome", produto.FornecedorId);
      return View(produto);
    }
